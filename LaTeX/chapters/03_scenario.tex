...
\begin{figure}[htb]
  \centering
  \resizebox*{.8\textwidth}{!}{\input{figures/scenario}} \caption[Scheme of
...
\begin{figure}[htb]
  \centering
  \resizebox*{.5\textwidth}{!}{\input{figures/ageplot}} 
...
Fig.~\ref{fig:ageplot} shows an exemplary evolution of $t_{i,g}$, along with the
